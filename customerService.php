...
<head>
    <title>Klantenservice - TellYourPhone</title>
    <meta charset="utf-8">
...
<body class="bg-light">
    ...
    <main class="container mb-5" style="max-width: 80%;">
        <div class="text-center py-4 mb-4">
            <h1 class="fw-bold text-primary display-5">Klantenservice</h1>
            <p class="text-muted fs-5">Hoe kunnen we je vandaag helpen?</p>
        </div>

        <div class="row g-3 text-center mb-5">
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm p-3 bg-white rounded-3">
                    <i class="bi bi-truck text-primary display-6 mb-2"></i>
                    <h5 class="fw-bold text-dark">Bestellingen & Bezorging</h5>
                    <p class="small text-muted mb-0">Volg je pakketstatus of wijzig bezorgtijden.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm p-3 bg-white rounded-3">
                    <i class="bi bi-arrow-counterclockwise text-primary display-6 mb-2"></i>
                    <h5 class="fw-bold text-dark">Retour & Bedenktijd</h5>
                    <p class="small text-muted mb-0">Informatie over retourneren binnen 31 dagen.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm p-3 bg-white rounded-3">
                    <i class="bi bi-credit-card text-primary display-6 mb-2"></i>
                    <h5 class="fw-bold text-dark">Betalingen & Facturen</h5>
                    <p class="small text-muted mb-0">Vragen over iDEAL, creditcard of maandbedragen.</p>
                </div>
            </div>
        </div>

        <h3 class="fw-bold mb-3 text-dark fs-4">Veelgestelde vragen</h3>
        <div class="accordion shadow-sm rounded-3 overflow-hidden mb-5" id="faqAccordion">

            <div class="accordion-item border-0 border-bottom">
                <h2 class="accordion-header">
                    <button class="accordion-button fw-semibold" type="button" data-bs-toggle="collapse" data-bs-target="#faq1">
                        Wanneer wordt mijn smartphone geleverd?
                    </button>
                </h2>
                <div id="faq1" class="accordion-collapse collapse show" data-bs-parent="#faqAccordion">
                    <div class="accordion-body bg-white text-muted">
                        Als je op werkdagen voor 23:59 uur bestelt via onze website, wordt je bestelling de volgende dag gratis via PostNL bezorgd.
                    </div>
                </div>
            </div>
            ...
            <div class="accordion-item border-0 border-bottom">
                <h2 class="accordion-header">
                    <button class="accordion-button collapsed fw-semibold" type="button" data-bs-toggle="collapse" data-bs-target="#faq2">
                        Hoe werkt de 31 dagen bedenktijd?
                    </button>
                </h2>
                <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                    <div class="accordion-body bg-white text-muted">
                        Je mag je toestel thuis rustig bekijken. Bevalt het niet? Dan kun je het binnen 31 dagen geheel kosteloos en in originele verpakking naar ons retourneren.
                    </div>
                </div>
            </div>
            ...
            <div class="accordion-item border-0">
                ...
                <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                    <div class="accordion-body bg-white text-muted">
                        Ja! Bij providers zoals Odido, KPN en Vodafone kun je via je persoonlijke account maandelijks je databundel omhoog of omlaag bijstellen.
                    </div>
                </div>
            </div>
        ...
        <div class="card bg-primary text-white border-0 shadow rounded-4 p-4 text-center">
            <h4 class="fw-bold mb-2">Staat je vraag er niet tussen?</h4>
            <p class="mb-4 opacity-75">Onze klantenservice zit elke dag voor je klaar om te helpen.</p>
            <div class="d-flex flex-wrap justify-content-center gap-3">
                <div class="bg-white bg-opacity-25 px-4 py-2 rounded-pill small">
                    <i class="bi bi-telephone-fill me-2"></i> 0800 - 1234 567
                </div>
                <div class="bg-white bg-opacity-25 px-4 py-2 rounded-pill small">
                    <i class="bi bi-envelope-fill me-2"></i> info@tellyourphone.nl
                </div>
            </div>
        </div>
    </main>
